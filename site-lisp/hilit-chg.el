...
;; Face information: How the changes appea.
...
(defface highlight-changes
  '((((min-colors 88) (class color) (background light)) (:background "#FFcccc"))
    (((min-colors 88) (class color) (background dark)) (:background "#660000" ))
    (t (:inverse-video t)))
...
(defface highlight-changes-delete
  '((t :inherit highlight-changes (:inverse-video t)))
...
(defcustom highlight-changes-colors
  (if (eq (frame-parameter nil 'background-mode) 'light)
      ...
      '( "#FFDDFF" "#DDDDFF" "#DDFFDD" "#F8D8C5" "#FFF0a0")
      ;; defaults for dark background:
    '( "#3F003F" "#333300" "#330044" "#18384e" "#111F6F"))
...
(defun hilit-chg-make-list (&optional force)
  ...
  (if (or (null highlight-changes-face-list)  ; Don't do it if it
	...
	(while p
	  ...
	  (set-face-background name (car p))
